...
// returns the numeral value of that digit. 0 represents the ones digit, 
// 1 represents the tens digit, etc. Given (1824,2), return 8. 
...
function exact(a,b){
    let aStr = a.toString();
    let negStr = a-Math.floor(a).toString();
    console.log(negStr);
    if(a%1==0){
        if(aStr.length-1<b){
            return(0);
